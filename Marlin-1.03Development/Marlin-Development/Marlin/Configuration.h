...
#define STRING_URL "jackcleveland.name"
#define STRING_VERSION_CONFIG_H __DATE__ " " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "Jack Cleveland " // Who made the changes.
#define STRING_SPLASH_LINE1 "Crossbot" STRING_VERSION // will be shown during bootup in line 1
...
#define CUSTOM_MENDEL_NAME "Crossbot"
...
#define EXTRUDER_OFFSET_X {-18.0, 0 } // (in mm) for each extruder, offset of the hotend on the X axis 
